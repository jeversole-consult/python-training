...
The approach used here is ad-hoc and roughly uses the following guidelines:
* Both parent and child

**[madtek.com](https://madtek.com)**  **bold example**, place holder on how to format text.
...
## Licenseespecially data science, object oriented architecture, and it is an interpreted scripting language. 

due to its aims to provide **accurate**, **non-judgmental**, and **understandable** information about popular **open source licenses** in order to **help people make informed decisions** about the projects they start, maintain, contribute to, and use.
