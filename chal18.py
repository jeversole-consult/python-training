...
1) Big Endian vs Little Endian: It has been sometime since I cared about big/little endian formatting. In the past I was
dealing with graphics files and hardware which is at the byte level. As I read this challenge it is at the "block" level 
so think of it as the least significant block. I had to look closely at the example keystreams to find the counter in 
the 3 keystreams.

2) This exercise is the first introduction of a keystream. How the keystream works is essential to understanding how the
CTR cipher works. 
--------------------------------------------------------------------------------------------------
"""
import pdb
...
b64str = "L77na/nrFsKvynd6HzOoG7GHTLXsTVu9qvY/2syLXzhPweyyMTJULu/6/kXX0KSvoOLSFQ=="

ctext = base64.b64decode(b64str.encode('latin-1'))
